...
${KUBEVIRT_DIR}/tools/openapispec/openapispec --dump-api-spec-path ${KUBEVIRT_DIR}/api/openapi-spec/swagger.json --dump-api-spec-v3-path ${KUBEVIRT_DIR}/api/openapi-spec/openapi-v3.json
