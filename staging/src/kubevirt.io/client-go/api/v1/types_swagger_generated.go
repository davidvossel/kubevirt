...
func (VirtualMachineInstanceStatus) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"currentLauncherImage": "CurrentLauncherImage contains the launcher container image\nthat is currently active for this vmi\n+optional",
	}
}
...
func (KubeVirtWorkloadUpdateStrategy) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"batchShutdownSize":     "BatchShutdownSize Represents the number of VMIs that can be forced updated per\nthe BatchShutdownInteral interval\n\nDefaults to 10\n\n+optional",
