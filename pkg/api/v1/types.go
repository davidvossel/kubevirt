...
const (
	...
	KubeVirtConditionDeploymentSuccessful KubeVirtConditionType = "DeploymentSuccessful"
	// Whether the deletion was successful
	KubeVirtConditionDeletionSuccessful KubeVirtConditionType = "DeletionSuccessful"
)
