...
func newValidPatchRequest() *http.Request {
	request, _ := http.NewRequest("PATCH", "/apis/kubevirt.io/v1/namespaces/default/virtualmachineinstances/test", nil)
...
var _ = Describe("Patch", func() {
	...
	BeforeEach(func() {
		...
		ws.Route(ws.PATCH("/apis/kubevirt.io/v1/namespaces/{namespace}/virtualmachineinstances/{name}").To(target))
