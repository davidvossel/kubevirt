...
func newValidJSONPostRequest() *http.Request {
	request, _ := http.NewRequest("POST", "/apis/kubevirt.io/v1/namespaces/default/virtualmachineinstances", nil)
...
var _ = Describe("Post", func() {
	...
	BeforeEach(func() {
		...
		ws.Route(ws.POST("/apis/kubevirt.io/v1/namespaces/{namespace}/virtualmachineinstances").To(target))
